...
This repository is automatically generated using:

```console
docker run --rm \
    -v $PWD:/local -v ~/code/open-graph-api-go/:/out openapitools/openapi-generator-cli generate \
    -i /local/api/openapi-spec/v0.0.yml --additional-properties=packageName=opengraph \
    -g go \
    -o /out
```
