...
func (o *Quota) GetStoragePlanInformation() StoragePlanInformation {
	if o == nil || o.StoragePlanInformation == nil {
		var ret StoragePlanInformation
		return ret
	}
...
// SetStoragePlanInformation gets a reference to the given StoragePlanInformation and assigns it to the StoragePlanInformation field.
