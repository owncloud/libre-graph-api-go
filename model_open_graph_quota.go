...
type OpenGraphQuota struct {
	...
	StoragePlanInformation *OpenGraphStoragePlanInformation `json:"storagePlanInformation,omitempty"`
...
// GetStoragePlanInformation returns the StoragePlanInformation field value if set, zero value otherwise.
func (o *OpenGraphQuota) GetStoragePlanInformation() OpenGraphStoragePlanInformation {
	if o == nil || o.StoragePlanInformation == nil {
		var ret OpenGraphStoragePlanInformation
		return ret
	}
...
// SetStoragePlanInformation gets a reference to the given OpenGraphStoragePlanInformation and assigns it to the StoragePlanInformation field.
